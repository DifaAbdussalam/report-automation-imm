  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="frm-import" method="post" class="form-horizontal" action="<?php echo site_url('ping_rtt_ms_0/upload'); ?>" enctype="multipart/form-data">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
		...
		<div class="modal-body">
        <form id="frm-import" method="post" class="form-horizontal" action="<?php echo site_url('ping_rtt_ms_0/export'); ?>" enctype="multipart/form-data">
			<div class="form-group">
...
$(document).ready(function() {
	...
	$("#kota").change(function(){
		...
		$.ajax({
			type: "POST",
			url : "<?php echo site_url('ping_rtt_ms_0/filter_kota');?>",
			data: {kota:kota},
			beforeSend: function (){
				$(".modal").show();
			},
