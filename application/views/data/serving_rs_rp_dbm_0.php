...
<section class="content-header">
  <h1>Data serving_rs_rp_dbm_0</h1>
	<ol class="breadcrumb">
	<li><a href="#">Data</a></li>
		  ...
		  <table id="myTable" class="display table-bordered table-striped table-hover" cellspacing="0" width="100%">
			...
			if($mdata->num_rows()>0){
				...
				foreach($mdata->result() as $rows){
					...
					echo '<td>'.$rows->RSRP.'</td>';
					echo '<td>'.$rows->NumMeasuredCells.'</td>';
					echo '<td>'.$rows->ChnPCI.'</td>';
					echo '</tr>';
					$no++;
				}
			}
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="frm-import" method="post" class="form-horizontal" action="<?php echo site_url('serving_rs_rp_dbm_0/upload'); ?>" enctype="multipart/form-data">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
		...
		<div class="modal-body">
        <form id="frm-import" method="post" class="form-horizontal" action="<?php echo site_url('serving_rs_rp_dbm_0/export'); ?>" enctype="multipart/form-data">
			<div class="form-group">
...
$(document).ready(function() {
	...
	$("#kota").change(function(){
		...
		$.ajax({
			type: "POST",
			url : "<?php echo site_url('serving_rs_rp_dbm_0/filter_kota');?>",
			data: {kota:kota},
			beforeSend: function (){
				$(".modal").show();
			},
