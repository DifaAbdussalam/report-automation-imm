...
<div class="box-body">
  <div class="row">
	<div class="col-md-12">
	  <form id="frm" method="post" class="form-horizontal" action="<?php echo site_url('provider/save'); ?>" enctype="multipart/form-data">
		<div class="box-body">
			<div class="form-group">
				<label class="control-label col-sm-2" for="id_mnc">ID Mnc</label>
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="id_mnc" name="id_mnc" placeholder="ID Mnc" required>
				</div>
			</div>
			<div class="form-group">
