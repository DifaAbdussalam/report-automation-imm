...
<section class="content">
	...
	<div class="col-md-12">
		<div class="box box-primary">
			...
			<form id="frm" method="get" class="form-horizontal" action="<?php echo site_url('chart_ping'); ?>" enctype="multipart/form-data">
			<div class="box-body">
  ...
  <div class="row">
	...
	Highcharts.chart('container-avg', {
		...
		Highcharts.chart('container-loss', {
		chart: {
			type: 'bar'
		},
		title: {
