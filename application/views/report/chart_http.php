...
<section class="content">
	...
	<div class="col-md-12">
		<div class="box box-primary">
			...
			<form id="frm" method="get" class="form-horizontal" action="<?php echo site_url('chart_http'); ?>" enctype="multipart/form-data">
			<div class="box-body">
  ...
  <div class="row">
	...
	Highcharts.chart('container-avg', {
		...
		title: {
			text: 'Average HTTP Throughput (Mbps)'
		},
		subtitle: {
			text: ''
		},
		...
		title: {
			text: 'Browsing HTTP Success Rate (%)'
		},
		subtitle: {
			text: ''
		},
