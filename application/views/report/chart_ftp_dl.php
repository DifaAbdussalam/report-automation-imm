...
<section class="content">
	...
	<div class="col-md-12">
		<div class="box box-primary">
			...
			<form id="frm" method="get" class="form-horizontal" action="<?php echo site_url('chart_ftp_dl'); ?>" enctype="multipart/form-data">
			<div class="box-body">
  ...
  <div class="row">
	...
	<script type="text/javascript">
		...
		title: {
			text: 'Min FTP Download Throughput (Mbps)'
		},
		subtitle: {
			text: ''
		},
	...
	Highcharts.chart('container-max', {
		...
		title: {
			text: 'Max FTP Download Throughput (Mbps)'
		},
		subtitle: {
			text: ''
		},
	...
	Highcharts.chart('container-avg', {
		...
		title: {
			text: 'Average FTP Download Throughput (Mbps)'
		},
		subtitle: {
			text: ''
		},
		...
		title: {
			text: 'FTP Download Success Rate (%)'
		},
		subtitle: {
			text: ''
		},
