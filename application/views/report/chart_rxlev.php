...
<section class="content">
	...
	<div class="col-md-12">
		<div class="box box-primary">
			...
			<form id="frm" method="get" class="form-horizontal" action="<?php echo site_url('chart_rxlev'); ?>" enctype="multipart/form-data">
			<div class="box-body">
  ...
  <div class="row">
	...
	<?php
	$dataList=$this->chart_model->chart_rxlev($row->provider,$kota,$sdate,$edate);
	?>
